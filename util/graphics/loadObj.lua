...
return function(path)
	local zMultiplier = consts.entityLoadObjZMultiplier
		...
		for word in line:gmatch("%S+") do
			if item then
				if isTri then
					...
					local vert = {
						v[1], v[2], v[3] * zMultiplier,
						vt[1], 1 - vt[2], -- Y coordinate is flipped due to love/opengl discrepancy
						vn[1], vn[2], vn[3] * zMultiplier
					}
	...
	return love.graphics.newMesh(consts.entityVertexFormat, outVerts, "triangles")
end
